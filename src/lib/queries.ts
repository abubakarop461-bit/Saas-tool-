...
export const SEED_PROPERTIES: Property[] = [
  ...
  },
  {
    ...
    listing_type: 'Exclusive',
    source_type: 'Mandate',
    owner_name: 'Rajesh & Sunita Gupta',
  ...
  },
  {
    ...
    listing_type: 'Exclusive',
    source_type: 'Direct',
    owner_name: 'Kanoiya Elite Family',
    owner_contact: '+91 98220 11999',
    unit_no: 'Unit 402',
    brokerage: '2%',
    listing_nature: 'standalone',
    description: 'Vastu compliant 3 BHK luxury apartment at Phulam Chamber, complete with modular kitchen and covered car parking.',
    created_at: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString()
  },
  {
    id: 'prop-014',
