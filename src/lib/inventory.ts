...
export const SEED_DEVELOPER_UNITS: DeveloperUnit[] = [
  ...
  },
  {
    ...
    project_title: 'Kuchu Puchu',
    tower: 'Tower A',
    floor: 20,
    unit_number: 'TA-2001',
    configuration: '4 BHK Sky Suite',
    carpet_area: 2100,
    built_up_area: 2750,
    facing: 'North-East Panoramic Skyline',
    base_price: 20000000,
    floor_rise_rate: 100,
  ...
  },
  {
    ...
    possession_date: 'December 2027',
    status: 'Token',
    buyer_name: 'Vikramjit Singhania',
    agent_name: 'Rishi Mahboobani'
  },
  {
    id: 'u-kp-tc-1501',
